    ...
    const fetchData = async () => {
        try {
            ...
            setProduct({
                ...
                supplierId: getProduct.supplier?.supplierId,
                unit: getProduct.unit,
                quantity: getProduct.quantity,
                description: getProduct.description,
                importPrice: getProduct.importPrice,
                salePrice: getProduct.salePrice,
                discount: getProduct.discount,
                discountType: getProduct.discountType,
                metaTitle: getProduct.metaTitle,
                metaKeywords: getProduct.metaKeywords,
                metaDescription: getProduct.metaDescription,
            });
        ...
        console.log('Fetched TRONG', product);
    };
        ...
        <Spin spinning={loading}>
            <form action=""  >
                ...
                <div className="row" >
                    ...
                    <div className="col-sm-8">
                        <div className="row">
                            {hasSelectedImages || imagesP.length > 0 ? (
                                <div className="rounded-md border">
                                    {/* ... (phần đã được giữ nguyên) */}
                                            ...
                                            {selectedImages.map((image, index) => (
                                                <div key={index} className="col-ms-3 col-image" style={{ position: "relative" }}>
                                                    ...
                                                    <a
                                                        ...
                                                        style={{ position: "absolute", top: "5px", right: "5px", background: "transparent", border: "none" }}
                                                    >
                                                        Xóa
                                                    </a>
                                                </div>
                                    ...
                                    {imagesP.length > 0 ? (
                                        <div className="row" style={{ display: "flex" }}>
                                            {imagesP.map((image, index) => (
                                                <div key={index} className="col-ms-3 col-image" style={{ position: "relative" }}>
                                                    <img
                                                        src={`http://localhost:8080/api/admin/customers/${image.imageUrl}`}
                                                        alt={`Selected ${index}`}
                                                        style={{ width: "100%", height: "100%", objectFit: "cover" }}
                                                    />
                                                    <button
                                                        onClick={() => handleImageDeleteL(index)}
                                                        style={{ position: "absolute", top: "5px", right: "5px", background: "transparent", border: "none" }}
                                                    >
                                                        Xóa
                                                    </button>
