                ...
                <thead className="thead-cell">
                    <tr>
                        ...
                        <th className='rc-table-cell' scope="col">
                            <div className="flex items-center">
                                <font style={{ verticalAlign: "inherit" }}>
                                    <font style={{ verticalAlign: "inherit" }}>MÃ HÀNG</font>
                                </font>
                            </div>
                        </th>
                        <th className='rc-table-cell' scope="col">
                ...
                <tbody>
                    {products.map(product => (
                        <tr key={product.id}>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="grid gap-0.5">
                                        <p className="font-lexend text-sm font-medium text-gray-900 dark:text-gray-700">
                                            Táo Nhập Khẩu Của Đà Nẵng
                                        </p>
                                        <p className="text-[13px] text-gray-500">Trái Cây</p>
                                    </div>
                                </div>
                            </td>
                            <td className="td-table-cell">
                            ...
                            <td className="td-table-cell">
                                <p className="text-sm">420.000vnd</p>
                            </td>
                            <td className="td-table-cell">
                            ...
                            <td className="td-table-cell">
                                <div className="flex items-center">
                                    <span className="me-1 shrink-0">3.7</span>
                                    ...
                                    <span className="ms-1 shrink-0">(14)</span>
                                </div>
                            </td>
                            <td className="td-table-cell">
