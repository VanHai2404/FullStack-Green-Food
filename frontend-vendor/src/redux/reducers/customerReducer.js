...
const customerReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case ADD_CUSTOMER_FAILURE:
      toast.error('Đã xảy ra lỗi khi thêm khách hàng.', { position: toast.POSITION.TOP_RIGHT });
      return {
        ...state,
        loading: false,
        error: action.payload
      ...
      toast.error('thêm hình ảnh khách hàng thất bại.', { position: toast.POSITION.TOP_RIGHT });
      return {
        ...state,
        loading: false,
        error: action.payload
