...
const LisItemCategory = () => {
    ...
    const categories = [
        { name: 'Rau sạch', href: '/search?category=fresh-vegetables', image: hinh1 },
        { name: 'Thực phẩm ăn kiêng', href: '/search?category=fresh-vegetables', image: hinh2 },
        { name: 'Mặt hàng trái cây', href: '/search?category=fresh-vegetables', image: hinh3 },
        { name: 'Mặt hàng trái cây', href: '/search?category=fresh-vegetables', image: hinh3 },
        ...
        { name: 'Các loại thực phẩm lành mạnh', href: '/search?category=fresh-vegetables', image: hinh6 },
